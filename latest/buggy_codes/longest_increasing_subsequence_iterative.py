# Inputs fail when the optimal subsequence for an index comes from a smaller-valued predecessor whose stored subsequence is longer than the larger-valued compatible predecessor. For example, mixed sequences with dips and later recovery such as [4, 8, 7, 5, 1, 12, 2, 3, 9] or [28, 26, 12, 23, 35, 39] will return shorter subsequences. Monotone increasing inputs, purely decreasing inputs with a final duplicate-compatible value, empty inputs, and some simple duplicate cases may still pass.
"""
